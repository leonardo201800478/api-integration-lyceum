...
class ImportadorConteudos:
    ...
    def obter_dados_lyceum(self):
        print("  ⚠️  IMP-015: obter_dados_lyceum() não implementado.")
        return []

    def transformar_dados(self, dados_lyceum):
        print("  ⚠️  IMP-015: transformar_dados() não implementado.")
        return []
    ...
    def importar_para_qstione(self, dados_transformados):
        ...
        print("  ⚠️  IMP-015: importação simulada (nenhum dado inserido).")
        return {
            'total_inseridos': 0,
            'total_atualizados': 0,
            'total_erros': 0,
    ...
    def executar_importacao(self):
        print("=" * 70)
        print("IMPORTAÇÃO: imp_015_conteudos [ESQUELETO]")
        print("=" * 70)
