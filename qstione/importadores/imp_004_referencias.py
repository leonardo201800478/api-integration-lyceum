...
class ImportadorReferencias:
    ...
    def obter_dados_lyceum(self):
        print("  ⚠️  IMP-004: obter_dados_lyceum() não implementado.")
        return []

    def transformar_dados(self, dados_lyceum):
        print("  ⚠️  IMP-004: transformar_dados() não implementado.")
        return []
    ...
    def importar_para_qstione(self, dados_transformados):
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS imp_004_referencias (
                ...
                descricaoReferencia TEXT NOT NULL,
        ...
        print("  ⚠️  IMP-004: importação simulada (nenhum dado inserido).")
        return {
            'total_inseridos': 0,
            'total_atualizados': 0,
            'total_erros': 0,
    ...
    def executar_importacao(self):
        print("=" * 70)
        print("IMPORTAÇÃO: imp_004_referencias [ESQUELETO]")
        print("=" * 70)
