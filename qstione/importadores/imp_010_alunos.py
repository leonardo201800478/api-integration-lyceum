"""
Importador para tabela imp_010_alunos (Alunos)
...
class ImportadorAlunos:
    ...
    def obter_dados_lyceum(self):
        """Placeholder: futuramente buscará de LY_ALUNO"""
        print("  ⚠️  IMP-010: obter_dados_lyceum() não implementado (aguardando definição da tabela LY_ALUNO).")
        return []

    def transformar_dados(self, dados_lyceum):
        print("  ⚠️  IMP-010: transformar_dados() não implementado.")
        return []
    ...
    def importar_para_qstione(self, dados_transformados):
        ...
        print("  ⚠️  IMP-010: importação simulada (nenhum dado inserido).")
        return {
            'total_inseridos': 0,
            'total_atualizados': 0,
            'total_erros': 0,
    ...
    def executar_importacao(self):
        print("=" * 70)
        print("IMPORTAÇÃO: imp_010_alunos [ESQUELETO]")
        print("=" * 70)
